...
s.linkInternalFilters="javascript:,popcap.com"
...
function s_doPlugins(s) {
	...
	s.eVar37= s.campaign; 
	s.eVar1=s.getQueryParam('installtag'); 
	s.eVar2=s.getQueryParam('icid'); 
	s.eVar10=s.getQueryParam('mid'); 
	s.eVar38=s.eVar2; 
	...
	s.prop11=s.eVar9;
	s.eVar46=s.getQueryParam('whid') 
	s.eVar12=s.getQueryParam('cjpid'); 
	s.eVar30=s.getTimeParting('h','-8','2009'); // Set hour
	s.eVar31=s.getTimeParting('d','-8','2009'); // Set day
	s.eVar32=s.getTimeParting('w','-8','2009'); // Set Weekend / Weekday

	document.cookie = "cookies=true";
	if (!document.cookie) {
		s.eVar18 = alternateID;
	}
	s.prop10 = s.eVar18;
...
s.visitorNamespace="popcapgames"
s.dc=122
...
/*
     FILE ARCHIVED ON 22:46:37 Oct 02, 2009 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 01:58:52 Jul 29, 2024.
...
playback timings (ms):
  ...
  esindex: 0.007
  cdx.remote: 6.7
  LoadShardBlock: 123.984 (3)
  PetaboxLoader3.datanode: 40.675 (4)
  PetaboxLoader3.resolve: 143.53 (2)
  load_resource: 90.48
*/